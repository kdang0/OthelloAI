...
/**
 * Min Priority queue--inspired by the book's example
 * @author Alex Friedman
 * @since 11/9/2020
 */
public class AMinPQ<K extends Comparable<K>> extends APQ<K>
{

	/**
	 * Constructs a new MinPriorityQueue of a given size.
	 * @param size The size of the MinPriorityQueue (the number of elements it could store w/o a resize in an ideal world)
	 */
	public AMinPQ(int size)
	{
		super(size);
	}
	...
	/**
	 * This removes and returns the minimum element in the queue (or null if empty).
	 * 
	 ...
	 * duplicating code. 
	 * @return The min element in the queue. 
	 */
	public K delMin() { return pop(); }
